...
export default function Startmatch(props) {
  ...
  return ( 
    ...
    <div className='teams w-auto my-3 rounded-md bg-blue-100 '>
     ...
     <input type='text' placeholder='Australia' className='w-3/4 p-3 my-4 mx-3 rounded-md' onChange={props.change2}></input> 
     ...
     <input type='text' placeholder='Starc' className='w-3/4 p-3 my-4 mx-3 rounded-md' onChange={props.change6}></input>
